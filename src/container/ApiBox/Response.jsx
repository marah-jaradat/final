    ...
    <React.Fragment>
      <div className="mb-3 app__bg">
        ...
        <div className="tab-content" id="pills-tabContent">
          <div
            // className="tab-pane app__bg fade show active"
            // id="pills-data"
            role="tabpanel"
            aria-labelledby="pills-data-tab"
          >
            <div
              className="data-content border app__bg border-1 rounded p-3"
              style={{
                width: "605px",
                height: "246px",
              }}
          ...
          >
            <div
              className="resheader-content border app__bg border-1 rounded p-3"
              style={{
                width: "605px",
                height: "246px",
              }}
            >
              <JSONPretty data={JSON.stringify(responseHeaders)} />
            </div>
          </div>
          <div
            // className="tab-pane fade"
          ...
          >
            <div
              className="cookie-content app__bg border border-1 rounded p-3"
              style={{
                width: "605px",
                height: "246px",
              }}
